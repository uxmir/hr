...
//   //creating profiledata
//   const createProfileData = async (formData) => {
//     const token = localStorage.getItem("token");
//     if (!token) {
//       alert("token is not found in localStorage");
//       return;
//     }
//     const create_api = process.env.NEXT_PUBLIC_PROFILE_API;
//     try {
...
//       }
//     } catch (error) {
//       console.error("data is not created from front-end", error);
//     }
//   };
//   //gettingdata
//   const getProfileData = async () => {
...
//       });
//       const data = await response.json();
//      if(data.success&& data.getProfile){
...
//      }
//     } catch (error) {
//       console.error("data is not found from frontend", error);
//       setProfileData(null)
//     }finally{
//       setIsLoading(false)
//     }
//   };
//   //reloading data in frontend
//   useEffect(()=>{
//   getProfileData()
//   },[])
//   return (
//     <ProfileContext.Provider
//       value={{ profileData, setProfileData, createProfileData,isLoading}}
//     >
//       {children}
//     </ProfileContext.Provider>
//   );
